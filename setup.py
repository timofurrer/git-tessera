...
setup(
    ...
    author="André Roth, Timo Furrer",
    author_email="neolynx@gmail.com, tuxtimo@gmail.com",
    maintainer="André Roth, Timo Furrer",
    maintainer_email="neolynx@gmail.com, tuxtimo@gmail.com",
